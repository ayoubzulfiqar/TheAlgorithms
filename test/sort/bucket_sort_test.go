...
func BenchmarkINTBucketSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.Bucket(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATBucketSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
