...
func TestCockTailFloatSort(t *testing.T) {
	// Test case: Unsorted array
...
func BenchmarkINTCockTailSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.CockTail(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATCockTailSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
