...
func BenchmarkINTCountingSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.Counting(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATCountingSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
