...
func TestGenomeFloatSort(t *testing.T) {
	// Test case: Unsorted array
...
func BenchmarkINTGenomeSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.Gnome(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATGnomeSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
