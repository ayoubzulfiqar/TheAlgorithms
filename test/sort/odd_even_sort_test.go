...
func TestOddEvenFloatSort(t *testing.T) {
	// Test case: Unsorted array
...
func BenchmarkINTOddEvenSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.OddEven(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATOddEvenSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
