...
func BenchmarkINTThreeWayMergeSort(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		b.StartTimer()
		sorts.ThreeWayMerge(arrayCopy)

		b.StopTimer()
	}
}

func BenchmarkFLOATThreeWayMergeSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
