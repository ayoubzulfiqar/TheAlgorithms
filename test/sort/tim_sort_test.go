...
func TestTimFloatSort(t *testing.T) {
	// Test case: Unsorted array
...
func BenchmarkINTTimSort(b *testing.B) {
...
func BenchmarkFLOATTimSort(b *testing.B) {
	// Generate a random unsorted array for each benchmark iteration
